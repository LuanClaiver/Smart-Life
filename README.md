...
<h1 align="center">Smart Life v0.9.5</h1>

## 🆕 Smart Life v0.9.5

- Corrigida a sincronização criptografada com Supabase no celular e computador.
- URL do Supabase é validada e normalizada automaticamente.
- Smart IA padronizada em toda a interface.
- Scripts, GitHub Actions, APK/AAB, README e arquivos internos usam a mesma versão v0.9.5.
- Infraestrutura do GitHub restaurada para voltar a gerar APK e AAB automaticamente.
...
<p align="center">
  🟢 Local e privado &nbsp;•&nbsp; 🎮 Gamificado &nbsp;•&nbsp; 📱 Android e computador &nbsp;•&nbsp; 🤖 Smart IA opcional
</p>
...
- **Smart IA:** missões, planejamento de metas, organização semanal e revisão semanal com Smart IA.
...
3. Baixe o artefato **Smart-Life-APK-v0.9.5**. Dentro dele estará o arquivo `Smart-Life-v0.9.5.apk`.
...
- A chave Smart IA não é incluída no backup.
...
- A geração com Smart IA agora pede **mais candidatas do que o necessário** e mantém somente as missões realmente diferentes entre si e das missões recentes/abertas.
...
- Chamadas ao Smart IA agora usam **novas tentativas com espera progressiva** em falhas temporárias e um **modelo Flash-Lite reserva** quando o modelo principal está indisponível.
- Erros de alta demanda do Smart IA não exibem mais a mensagem técnica em inglês. O Smart Life mostra uma explicação curta em português.
...
- **Assistente local do Smart Life** para perguntas objetivas sobre seus próprios dados; a Central Smart IA permanece disponível para análises abertas quando configurada.
...
- Backup e restauração continuam disponíveis em JSON, sem incluir credenciais ou a chave Smart IA.
...
- O backup continua protegido, sem chave Smart IA e sem credenciais da sincronização.
...
- Revisão semanal local mostra resultados e também pode usar o Smart IA com confirmação.
...
- O Coordenador Smart agora mantém uma conversa real com o Smart IA.
...
- Smart IA com geração de missões, planejamento de metas, organização semanal e revisão semanal.
- Permissões individuais para perfil, missões, hábitos, projetos e finanças.
- Teste de conexão do Smart IA e chave protegida nos backups.
