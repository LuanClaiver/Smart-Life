...
<h1 align="center">Smart Life v0.4.8</h1>
...
3. Baixe o artefato `Smart-Life-v0.4.8-debug`.
...
- Dados afetados pelo erro anterior são normalizados: uma reserva de R$ 3.110 em R$ 5.000 volta a mostrar 62,2%.
- Registros reais concedem +1 no atributo correspondente, com limite de 3 por atributo a cada dia.
- Hidratação, Vitalidade, Força, Inteligência, Foco e Carisma possuem limites independentes.
- Excluir um registro premiado remove o ponto concedido e libera novamente uma vaga no limite diário.
- Registros continuam sem conceder XP; o limite de 500 XP por dia permanece inalterado.
