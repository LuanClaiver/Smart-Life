...
<h1 align="center">Smart Life v0.8.5</h1>
...
- Scripts, GitHub Actions, APK/AAB, README e arquivos internos usam a mesma versão v0.8.5.
...
3. Baixe o artefato **Smart-Life-APK-v0.8.5**. Dentro dele estará o arquivo `Smart-Life-v0.8.5.apk`.
