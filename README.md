...
<h1 align="center">Smart Life v0.8.9</h1>
...
- Scripts, GitHub Actions, APK/AAB, README e arquivos internos usam a mesma versão v0.8.9.
...
3. Baixe o artefato **Smart-Life-APK-v0.8.9**. Dentro dele estará o arquivo `Smart-Life-v0.8.9.apk`.
