...
<h1 align="center">Smart Life v0.7.6</h1>

## 🆕 Novidades v0.7.6 — sincronização e padronização
...
- Scripts, Actions, APK/AAB, README e arquivos internos usam a mesma versão v0.7.6.
...
3. Baixe o artefato **Smart-Life-APK-v0.7.6**. Dentro dele estará o arquivo `Smart-Life-v0.7.6.apk`.
